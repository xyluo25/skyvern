...
sys.path.append(str(dir_current.parent))
sys.path.append(str(dir_current.parent.parent))
...
from visualizer.api import SkyvernClient
from visualizer.artifact_loader import (
    read_artifact_safe,
    streamlit_content_safe,
    streamlit_show_recording,
)
from visualizer.repository import TaskRepository
from visualizer.sample_data import supported_examples
...
# Streamlit UI Logic
st.markdown("# **:dragon: AlphaZoe :dragon:**")
